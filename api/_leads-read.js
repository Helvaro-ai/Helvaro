...
function mapLead(r) {
  ...
  return {
    ...
    /* Twee bronnen: de kolom Email (gezet door de mailbox, api/_email/
       mailbox.js, voor leads die per mail binnenkwamen) en de Notities-blob
       (gezet door het formulier als de lead e-mail koos in plaats van
       WhatsApp, api/form.js). */
    email:                 String(f.Email || readNotitiesFlag(f.fldoLRI5W12ThTls7 || f.Notities, 'email') || ''),
