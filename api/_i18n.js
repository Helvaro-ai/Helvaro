...
const TEKST = {
  ...
  'chk.whatsapp.sub': { nl: 'Je assistent werkt al via het gedeelde Helvaro-nummer. Wil je dat leads je eigen bedrijfsnaam zien? Koppel je eigen nummer via Instellingen > WhatsApp > Nummer koppelen, of laat het ons weten en we helpen je.',
      fr: 'Votre assistant fonctionne déjà via le numéro Helvaro partagé. Vous voulez que vos leads voient le nom de votre entreprise ? Associez votre propre numéro via Paramètres > WhatsApp > Associer un numéro, ou faites-le-nous savoir et nous vous aidons.',
      en: 'Your assistant already works on the shared Helvaro number. Want leads to see your own business name? Connect your own number under Settings > WhatsApp > Connect number, or let us know and we will help.',
      de: 'Ihr Assistent arbeitet bereits über die gemeinsame Helvaro-Nummer. Sollen Leads Ihren eigenen Firmennamen sehen? Verbinden Sie Ihre eigene Nummer unter Einstellungen > WhatsApp > Nummer verbinden, oder sagen Sie uns Bescheid und wir helfen Ihnen.' },
  'wa.koppel.titel': { nl: 'WhatsApp koppelen', fr: 'Associer WhatsApp', en: 'Connect WhatsApp', de: 'WhatsApp verbinden' },
  'wa.koppel.tekst': { nl: 'We koppelen je nummer en laten het je weten zodra het live staat.', fr: 'Nous associons votre numéro et vous prévenons dès qu’il est actif.', en: 'We connect your number and let you know as soon as it is live.', de: 'Wir verbinden Ihre Nummer und melden uns, sobald sie aktiv ist.' },
  'wa.koppel.voorbeeld': { nl: 'Hallo,\n\nIk wil graag mijn WhatsApp-nummer laten koppelen aan Helvaro.\n\nNummer: \n', fr: 'Bonjour,\n\nJe souhaite associer mon numéro WhatsApp à Helvaro.\n\nNuméro : \n', en: 'Hello,\n\nI would like to connect my WhatsApp number to Helvaro.\n\nNumber: \n', de: 'Hallo,\n\nich möchte meine WhatsApp-Nummer mit Helvaro verbinden.\n\nNummer: \n' },
  ...
  'pi.customPromptPh': { nl: 'Bv: behoud de open haard, gebruik warmere kleuren', fr: 'Ex. : garder la cheminée, utiliser des couleurs plus chaudes', en: 'E.g. keep the fireplace, use warmer colours', de: 'Z. B.: Kamin behalten, wärmere Farben verwenden' },
  'ap.websitePh': { nl: 'https://www.jouwbedrijf.be', fr: 'https://www.votreentreprise.be', en: 'https://www.yourcompany.com', de: 'https://www.ihrefirma.de' },
  ...
  'inv.bron.instellen': { nl: 'Voorraadbron instellen', fr: 'Configurer la source du stock', en: 'Set stock source', de: 'Bestandsquelle einstellen' },
  'inv.bron.native.lang': { nl: 'Ik beheer mijn voorraad in Helvaro', fr: 'Je gère mon stock dans Helvaro', en: 'I manage my stock in Helvaro', de: 'Ich verwalte meinen Bestand in Helvaro' },
  'inv.bron.feed.lang': { nl: 'Mijn voorraad komt uit een ander systeem (feed)', fr: 'Mon stock vient d’un autre système (flux)', en: 'My stock comes from another system (feed)', de: 'Mein Bestand kommt aus einem anderen System (Feed)' },
  'inv.bron.url': { nl: 'Adres van de voorraadfeed', fr: 'Adresse du flux de stock', en: 'Stock feed address', de: 'Adresse des Bestandsfeeds' },
  'inv.bron.uitleg': { nl: 'CSV, JSON of XML via https (bv. een export van je DMS of AutoScout24). Wagens die uit de feed verdwijnen gaan naar "uit aanbod", nooit gewist.', fr: 'CSV, JSON ou XML via https (p. ex. un export de votre DMS ou d’AutoScout24). Les voitures qui disparaissent du flux passent en « retiré », jamais supprimées.', en: 'CSV, JSON or XML over https (e.g. an export from your DMS or AutoScout24). Cars that disappear from the feed are marked "removed", never deleted.', de: 'CSV, JSON oder XML über https (z. B. ein Export aus deinem DMS oder AutoScout24). Autos, die aus dem Feed verschwinden, werden „entfernt“ markiert, nie gelöscht.' },
  'mail.realtime': { nl: 'realtime: nieuwe mail komt meteen binnen', fr: 'temps réel : les nouveaux e-mails arrivent aussitôt', en: 'real-time: new mail arrives instantly', de: 'Echtzeit: neue Mails kommen sofort an' },
  'mail.koppel.ms': { nl: 'Outlook / Microsoft 365 koppelen', fr: 'Connecter Outlook / Microsoft 365', en: 'Connect Outlook / Microsoft 365', de: 'Outlook / Microsoft 365 verbinden' },
