...
const TEKST = {
  ...
  'pd.sold.hint': { nl: 'Verkocht of uit aanbod? Dan plant je AI er geen bezichtiging meer voor in.',
      fr: 'Vendu ou retiré de l’offre ? Votre IA ne planifiera plus de visite pour ce bien.',
      en: 'Sold or off the market? Then your AI will no longer schedule viewings for it.',
      de: 'Verkauft oder aus dem Angebot? Dann plant Ihre KI dafür keine Besichtigung mehr.' },
  ...
  'pd.rent': { nl: 'te huur',
      ...
      en: 'to rent',
      de: 'zu vermieten' },
  'pd.desc.ph': { nl: 'Wat je AI mag vertellen over dit pand. Alleen wat hier staat wordt genoemd &mdash; hij verzint niets bij.',
      fr: 'Ce que votre IA peut dire de ce bien. Seul ce qui figure ici sera mentionné &mdash; elle n’invente rien.',
      en: 'What your AI may say about this property. Only what is written here gets mentioned &mdash; it invents nothing.',
      de: 'Was Ihre KI über diese Immobilie sagen darf. Nur was hier steht, wird genannt &mdash; sie erfindet nichts dazu.' },
  ...
  'biz.intro': { nl: 'Dit is wat je AI gebruikt om leads te beantwoorden — hoe meer je hier invult, hoe beter je AI jouw klanten écht helpt in plaats van generiek te antwoorden. Een paar zinnen per vraag is al genoeg.',
      fr: 'C’est ce que votre IA utilise pour répondre aux prospects — plus vous remplissez ici, plus votre IA aide vraiment vos clients au lieu de répondre de façon générique. Quelques phrases par question suffisent déjà.',
      en: 'This is what your AI uses to answer leads — the more you fill in here, the more your AI genuinely helps your clients instead of answering generically. A few sentences per question is already enough.',
      de: 'Das nutzt Ihre KI, um Leads zu beantworten — je mehr Sie hier ausfüllen, desto eher hilft Ihre KI Ihren Kunden wirklich, statt generisch zu antworten. Ein paar Sätze pro Frage reichen schon.' },
  ...
  'biz.never': { nl: 'Openingsuren &amp; dingen die de AI NOOIT mag beloven',
      fr: 'Heures d’ouverture &amp; choses que l’IA ne doit JAMAIS promettre',
      en: 'Opening hours &amp; things the AI must NEVER promise',
      de: 'Öffnungszeiten &amp; Dinge, die die KI NIEMALS versprechen darf' },
  ...
  'biz.append': { nl: 'Dit wordt toegevoegd aan je AI Instructies — je bestaande instructies (indien aanwezig) blijven staan, dit komt erbij.',
      fr: 'Ceci est ajouté à vos instructions IA — vos instructions existantes (le cas échéant) sont conservées, ceci vient s’y ajouter.',
      en: 'This is added to your AI instructions — your existing instructions (if any) stay in place, this comes on top.',
      de: 'Das wird Ihren KI-Anweisungen hinzugefügt — Ihre bestehenden Anweisungen (falls vorhanden) bleiben erhalten, dies kommt dazu.' },


  /* Losse eindjes: het infovak in Instellingen, de bedrijfsverhaal-modal en de Next.js-tip */
  'set.info.pre': { nl: 'Pas de AI-naam, welkomstbericht, werkuren en boekingsmodus aan via de',
      fr: 'Modifiez le nom de l’IA, le message de bienvenue, les heures de travail et le mode de réservation via la page',
      en: 'Change the AI name, welcome message, working hours and booking mode on the',
      de: 'Ändern Sie KI-Name, Willkommensnachricht, Arbeitszeiten und Buchungsmodus auf der Seite' },
  ...
  'chk.business.todo': { nl: 'Dit is wat je AI gebruikt om leads te beantwoorden — hoe meer context, hoe beter ze jouw klanten helpt.', fr: "C'est ce que votre IA utilise pour répondre aux prospects — plus il y a de contexte, mieux elle aide vos clients.", en: 'This is what your AI uses to answer leads — the more context, the better it helps your customers.', de: 'Damit beantwortet Ihre KI Leads — je mehr Kontext, desto besser hilft sie Ihren Kunden.' },
  'chk.business.done': { nl: 'Ingevuld — je AI kent je bedrijf', fr: 'Rempli — votre IA connaît votre entreprise', en: 'Filled in — your AI knows your business', de: 'Ausgefüllt — Ihre KI kennt Ihr Unternehmen' },
  'chk.business.action': { nl: 'Vertel het', fr: 'Compléter', en: 'Tell it', de: 'Ausfüllen' },
  'chk.ainame.title': { nl: 'Geef je AI een naam', fr: 'Donnez un nom à votre IA', en: 'Give your AI a name', de: 'Geben Sie Ihrer KI einen Namen' },
  ...
  'chk.gcal.todo': { nl: 'Dan checkt je AI automatisch je beschikbaarheid en zet boekingen meteen in je agenda.', fr: 'Votre IA vérifiera vos disponibilités et placera les rendez-vous directement dans votre agenda.', en: 'Your AI will check your availability and put bookings straight into your calendar.', de: 'Ihre KI prüft dann Ihre Verfügbarkeit und trägt Termine direkt in Ihren Kalender ein.' },
  ...
  'stat.qual.d': { nl: 'Door AI gekwalificeerd', fr: "Qualifiés par l'IA", en: 'Qualified by the AI', de: 'Von der KI qualifiziert' },
