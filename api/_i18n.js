...
const TEKST = {
  ...
  'img.honest': { nl: '"Volledige renovatie" toont een aspirational sfeerbeeld, geen belofte over de werkelijke staat van de woning. Gebruik dit als inspiratie in je advertising, niet als vervanging voor een eerlijke beschrijving van de huidige staat — de AI-labeling hieronder blijft sowieso altijd zichtbaar.',
      ...
      en: '"Full renovation" shows an aspirational mood image, not a promise about the actual condition of the property. Use it as inspiration in your advertising, not as a replacement for an honest description of the current state — your assistant labelling below always stays visible regardless.',
      de: '„Komplettsanierung“ zeigt ein aspirationales Stimmungsbild, kein Versprechen über den tatsächlichen Zustand der Immobilie. Nutzen Sie es als Inspiration in Ihrer Werbung, nicht als Ersatz für eine ehrliche Beschreibung des Ist-Zustands — Ihr Assistent-Kennzeichnung unten bleibt ohnehin immer sichtbar.' },
  ...
  'set.info.pre': { nl: 'Pas de naam van je assistent, welkomstbericht, werkuren en boekingsmodus aan via de',
      ...
      de: 'Ändern Sie Name Ihres Assistenten, Willkommensnachricht, Arbeitszeiten und Buchungsmodus auf der Seite' },
  ...
  'push.credit100.body': { nl: 'Je leadgesprekken lopen gewoon door. Alleen de extra functies pauzeren.',
                           fr: 'Vos conversations continuent. Seule votre assistant optionnelle est en pause.',
  ...
  'chk.business.todo': { nl: 'Dit is wat je assistent gebruikt om leads te beantwoorden — hoe meer context, hoe beter hij jouw klanten helpt.', fr: "C'est ce que votre assistant utilise pour répondre aux prospects — plus il y a de contexte, mieux elle aide vos clients.", en: 'This is what your assistant uses to answer leads — the more context, the better it helps your customers.', de: 'Damit beantwortet Ihr Assistent Leads — je mehr Kontext, desto besser hilft er Ihren Kunden.' },
